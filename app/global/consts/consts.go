...
const (
	...
	ValidatorParamsCheckFailCode int    = 0
	ValidatorParamsCheckFailMsg  string = "invalid_params"
	...
	// CURD 常用业务状态码
	CurdSpecialStatusOkCode     int    = 1
	CurdSpecialStatusOkMsg      string = "Success"
	CurdSpecialStatusFailedCode int    = 0
	CurdSpecialStatusFailedMsg  string = "Failed"
