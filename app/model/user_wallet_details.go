...
type UserWalletDetailsStruct struct {
...
func CreateWalletDetail(tx *gorm.DB, memId string, walletTypeId string, transType string, amount float64, lastBal float64) (*UserWalletDetailsStruct, error) {
	...
	memWallet := UserWalletDetailsStruct{
		MemberId:     memId,
		DocNo:		  docNo,
...
func GetWalletStatement(memId string, page int, limit int) ([]*UserWalletDetailsStruct, error) {
	var ewtStatement []*UserWalletDetailsStruct
	offset := (page - 1) * limit
