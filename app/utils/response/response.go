...
func Success(c *gin.Context, msg string, data interface{}) {
	...
	ReturnJson(c, http.StatusOK, consts.CurdSpecialStatusOkCode, msg, data)
}

func SuccessButFail(c *gin.Context, msg string, data interface{}) {
	//ReturnJson(c, http.StatusOK, consts.CurdSpecialStatusFailedCode, translation.Trans(msg), data)
	ReturnJson(c, http.StatusOK, consts.CurdSpecialStatusFailedCode, msg, data)
}
